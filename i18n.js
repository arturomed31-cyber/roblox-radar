...
const I18N = {
  en: {
    ...
    ch_note: (n, h) => `${n} readings across ${h} of monitoring, one every hour. Roblox publishes no player history, so this chart only grows as the radar keeps sampling; beyond 30 days it keeps one daily peak per game.`,
...
<div class="legal-meta">Last updated: September 2026</div>`,
  ...
  es: {
    ...
    tracked: (n, p) => `<b>${n}</b> juegos seguidos · <b>${p}</b> jugadores concurrentes`, lastRefresh: d => `última lectura ${d} UTC · lecturas cada hora, actualización completa diaria`,
    footer: 'Haz clic en cualquier miniatura para ver estadísticas completas, la gráfica de jugadores, el grupo de Roblox del creador y sus redes. Los datos vienen de las APIs públicas de Roblox y se leen cada hora; valoraciones, imágenes, redes y juegos nuevos se actualizan a diario a las 20:00 UTC. Las categorías y señales se asignaron leyendo nombre, descripción y género de cada juego — son un punto de partida para investigar, no un veredicto. "Copia de otro éxito" significa que la mecánica central sigue visiblemente a un juego anterior; "IP prestada" marca personajes o marcas con derechos de terceros.',
    ...
    ch_note: (n, h) => `${n} lecturas a lo largo de ${h} de seguimiento, una cada hora. Roblox no publica historial de jugadores, así que esta gráfica solo crece mientras el radar sigue midiendo; más allá de 30 días conserva un pico diario por juego.`,
